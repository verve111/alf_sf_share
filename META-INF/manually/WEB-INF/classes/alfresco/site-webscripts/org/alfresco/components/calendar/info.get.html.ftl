   ...
   <div class="yui-gd">
      ...
      <div class="yui-u">${(result.recurrence!"")?html}</div>
         ...
         <div class="yui-gd">
            ...
            <#if (result.isactive?? && result.isactive == "true")>
            <div class="yui-u"><input id="${el}-cron-isactive" type="checkbox" name="isactive" tabindex="4" disabled checked="checked"/></div>
            <#else>
            <div class="yui-u"><input id="${el}-cron-isactive" type="checkbox" name="isactive" tabindex="5" disabled/></div>
            </#if>
         </div>			 
