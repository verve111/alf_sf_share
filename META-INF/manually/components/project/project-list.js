                                        ...
                                        successCallback :
                                        {
                                            fn : function(response)
                                            {
                                                ...
                                                for ( var i in data)
                                                {
                                                    ...
                                                    html += '<div style="white-space: nowrap;display:inline-block;margin-right:5px;"><span class="task-legend" style="background-color:#' + taskLegend.color + '" ></span><span><a href='+Alfresco.util
                                                    ...
                                                    + taskLegend.label + ' ('+taskLegend.nbProjects +')</a></span>&nbsp;</div>';
                                                }
