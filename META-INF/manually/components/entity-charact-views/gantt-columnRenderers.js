                                    ...
                                    successCallback :
                                    {
                                        fn : function(response)
                                        {
                                            ...
                                            for ( var i in data)
                                            {
                                                ...
                                                html += '<div style="white-space: nowrap;display:inline-block;margin-right:5px;"><span class="task-legend" style="background-color:#' + taskLegend.color + '" ></span><span>' + taskLegend.label +'</span>&nbsp;</div>';
                                            }
