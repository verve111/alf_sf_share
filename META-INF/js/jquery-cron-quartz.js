    ...
    var methods = {
        init : function(opts) {
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                ...
                .data("root", this)
                .find("select")
                   //mein .gentleSelect(o.minuteOpts)
                    .data("root", this)
                    .end();
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                ...
                .find("select.cron-time-hour")
                    //mein .gentleSelect(o.timeHourOpts)
                    .data("root", this)
                    .end()
                .find("select.cron-time-min")
                    //mein .gentleSelect(o.timeMinuteOpts)
                    .data("root", this)
                    .end();
