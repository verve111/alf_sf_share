<@markup id="custom-sfdb-userform-js" target="js" action="replace">
   ...
   <@script src="${url.context}/res/components/userform/users.js" group="console"/>   
   <@script src="${url.context}/res/components/people-finder/group-finder.js" group="console"/>
</@>

<@markup id="custom-sfdb-userform" target="html" action="replace">
   <@uniqueIdDiv>
      <!--[if IE]>
      ...
      <div id="${el}-body" class="users">
         ...
         <div id="${el}-view" class="hidden">
            ...
            <div id="${el}-view-main" class="view-main separator">
               ...
               <div class="field-row">
                  <span class="field-label-right">Document Library Only:</span>
                  <span id="${el}-view-isDocLib" class="field-value"></span>
               </div>               
            </div>
         ...
         <div id="${el}-create" class="hidden">
            ...
            <div id="${el}-create-main" class="create-main">
               ...
               <#-- SFDB extension -->
               <div class="field-row">
                  <span class="crud-label"><input type="checkbox" id="${el}-create-isDocLib" />&nbsp;Document Library only</span>
               </div>                 
            </div>
         ...
         <div id="${el}-update" class="hidden">
            ...
            <div id="${el}-update-main" class="update-main">
               ...
               <#-- SFDB extension -->
               <div class="field-row">
                  <span class="crud-label"><input type="checkbox" id="${el}-update-isDocLib" />&nbsp;Document Library only</span>
               </div>                 
